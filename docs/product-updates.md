...
Now, by turning on personal connections, you can have Workbot authenticate user credentials and only let authorized users complete the requested actions e.g. approving expense, updating ticket status. 
